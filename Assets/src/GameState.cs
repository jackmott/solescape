...
public class GameState : MonoBehaviour
{
		...
		public static int numCol = 21;
		//number of columns before dependency list
		...
		private void CheckSeti ()
		{
				...
				if (r < setiChance) {
						...
						if (setiResearch == null && pendingResearch != null)
								setiResearch = pendingResearch;
		...
		public static List<PlanetInfo> LoadPlanets ()
		{
				...
				while (line != null) {
						PlanetInfo planetInfo = LoadPlanet (line);
